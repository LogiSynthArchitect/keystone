...
class _NotesListScreenState extends ConsumerState<NotesListScreen> {
  ...
  Widget _buildErrorState(BuildContext context, WidgetRef ref) {
    return KsErrorState(
      subtitle: 'Could not load notes. Check your connection and try again.',
      onRetry: () => ref.read(notesListProvider.notifier).load(),
    );
  }

  Widget _buildLoadingState() {
    return const KsShimmerList(itemCount: 4, itemHeight: 100);
  }
