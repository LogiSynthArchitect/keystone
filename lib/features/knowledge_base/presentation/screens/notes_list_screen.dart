          ...
          builder: (context, setInnerState) => KsFilterSheet(
            ...
            children: [
              KsFilterChipGroup(
                ...
                options: const [
                  KsFilterOption(value: 'car_lock_programming', display: 'CAR KEY'),
                  KsFilterOption(value: 'door_lock_installation', display: 'INSTALL'),
                  KsFilterOption(value: 'door_lock_repair', display: 'REPAIR'),
                  KsFilterOption(value: 'smart_lock_installation', display: 'SMART'),
                ],
              ),
            ],
          ),
