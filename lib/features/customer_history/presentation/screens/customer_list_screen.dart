            ...
            children: [
              KsFilterChipGroup(
                ...
                options: const [
                  ...
                  KsFilterOption(value: 'recent', display: 'RECENT'),
                  KsFilterOption(value: 'repeat', display: 'REPEAT'),
                ],
              ),
              KsFilterChipGroup(
                label: "PROPERTY TYPE",
                ...
                options: const [
                  KsFilterOption(value: 'residential', display: 'RESIDENTIAL'),
                  KsFilterOption(value: 'commercial', display: 'COMMERCIAL'),
                  KsFilterOption(value: 'automotive', display: 'AUTOMOTIVE'),
                ],
              ),
              KsFilterChipGroup(
                label: "LEAD SOURCE",
                ...
                options: const [
                  KsFilterOption(value: 'referral', display: 'REFERRAL'),
                  KsFilterOption(value: 'whatsapp', display: 'WHATSAPP'),
                  KsFilterOption(value: 'google_maps', display: 'GOOGLE'),
                  KsFilterOption(value: 'word_of_mouth', display: 'WORD OF MOUTH'),
                  KsFilterOption(value: 'physical_card', display: 'CARD'),
                  KsFilterOption(value: 'other', display: 'OTHER'),
                ],
              ),
            ],
          ),
