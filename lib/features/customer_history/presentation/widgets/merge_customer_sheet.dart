        ...
        try {
          ...
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text("Merge failed: $e"), backgroundColor: context.ksc.error500),
            );
          }
        }
      },
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Icon(LineAwesomeIcons.compress_solid, color: context.ksc.accent500, size: 20),
                const SizedBox(width: 12),
                Text("MERGE FROM", style: AppTextStyles.h3.copyWith(color: context.ksc.white, fontWeight: FontWeight.w900)),
              ],
            ),
          ),
          ...
          Expanded(
            child: _isLoading
                ...
                : _filtered.isEmpty
                    ? Center(
                        child: Text("No other customers found.",
