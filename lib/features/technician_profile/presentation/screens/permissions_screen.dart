        ...
        child: Column(
          ...
          children: [
            ...
            _buildToggle(
              context,
              ref,
              label: 'REQUIRE AFTER PHOTO',
              subtitle: 'Require an after-photo before a job can be marked completed.',
              value: perms.requireAfterPhoto,
              onChanged: (v) => _save(ref, perms.copyWith(requireAfterPhoto: v)),
            ),
          ],
        ),
      ),
