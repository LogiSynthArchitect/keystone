...
/// Maps service type [iconName] strings to LineAwesome [IconData].
class ServiceIconMap {
  ...
  static IconData resolve(String? iconName) {
    ...
    switch (iconName) {
      ...
      case 'unlock':            return LineAwesomeIcons.unlock_alt_solid;
      ...
      case 'bolt':              return LineAwesomeIcons.bolt_solid;
      ...
      case 'phone':             return LineAwesomeIcons.phone_solid;
      case 'cut':               return LineAwesomeIcons.cut_solid;
