...
import 'package:arclock/features/customer_history/data/models/customer_model.dart';
import 'package:arclock/features/job_logging/data/datasources/job_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_services_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_hardware_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_parts_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_expenses_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_photos_local_datasource.dart';
import 'package:arclock/features/job_logging/data/datasources/job_audit_local_datasource.dart';
import 'package:arclock/features/job_logging/data/models/job_model.dart';
import 'package:arclock/features/job_logging/data/models/job_service_model.dart';
import 'package:arclock/features/job_logging/data/models/job_hardware_model.dart';
import 'package:arclock/features/job_logging/data/models/job_part_model.dart';
import 'package:arclock/features/job_logging/data/models/job_expense_model.dart';
import 'package:arclock/features/job_logging/data/models/job_photo_model.dart';
import 'package:arclock/features/job_logging/data/models/job_audit_entry_model.dart';
import 'package:arclock/features/inventory/data/datasources/inventory_local_datasource.dart';
import 'package:arclock/features/inventory/data/datasources/inventory_restocks_local_datasource.dart';
import 'package:arclock/features/inventory/data/datasources/inventory_stock_adjustments_local_datasource.dart';
import 'package:arclock/features/inventory/data/models/inventory_item_model.dart';
import 'package:arclock/features/inventory/data/models/restock_model.dart';
import 'package:arclock/features/inventory/data/models/stock_adjustment_model.dart';
import 'package:arclock/features/inventory/domain/entities/inventory_item_entity.dart';
import 'package:arclock/features/knowledge_base/data/datasources/knowledge_note_local_datasource.dart';
import 'package:arclock/features/knowledge_base/data/models/knowledge_note_model.dart';
import 'package:arclock/features/knowledge_base/data/models/note_attachment_model.dart';
import 'package:arclock/features/note_links/data/datasources/note_link_local_datasource.dart';
import 'package:arclock/features/note_links/data/models/note_job_link_model.dart';
import 'package:arclock/features/whatsapp_followup/data/datasources/follow_up_local_datasource.dart';
import 'package:arclock/features/key_codes/data/datasources/key_code_local_datasource.dart';
import 'package:arclock/features/key_codes/data/models/key_code_entry_model.dart';
import 'package:arclock/features/reminders/data/models/reminder_model.dart';
import 'package:arclock/features/recurring_jobs/data/datasources/recurring_schedule_local_datasource.dart';
import 'package:arclock/features/recurring_jobs/domain/entities/recurring_schedule_entity.dart';
import 'package:arclock/features/job_templates/data/datasources/job_template_local_datasource.dart';
import 'package:arclock/features/job_templates/data/models/job_template_model.dart';
import 'package:arclock/features/job_templates/domain/entities/template_service_item.dart';
import 'package:arclock/features/job_templates/domain/entities/template_hardware_item.dart';
import 'package:arclock/features/job_templates/domain/entities/template_part_item.dart';
import 'package:arclock/features/job_templates/domain/entities/job_template_entity.dart';
import 'package:arclock/features/service_types/data/datasources/service_type_local_datasource.dart';
import 'package:arclock/features/service_types/data/models/service_type_model.dart';
